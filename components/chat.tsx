...
export default function Chat() {
    const [messages, setMessages] = useState<Message[]>([{
        role: "Assistant",
        content: "Hello! I am Akshay Maru's Personal Assistant. I can answer questions about Akshay's life, academics, family, projects, experience, and hobbies. How can I help you today?"
    }]);
